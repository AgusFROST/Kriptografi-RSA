...
<body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($nPublic != $nPrivate) {
                ...
                if ($action == 'encrypt') {
                        ...
                        echo '<div class="alert alert-success mt-3">Pesan Enkripsi: <span id="encryptedText">' . $cipherText . '</span></div>';
                        echo '<button class="btn btn-success" onclick="copyToClipboard()">Salin</button>';
    ...
    function copyToClipboard() {
        ...
        // Tambahkan textarea ke body, salin teks, dan hapus textarea
